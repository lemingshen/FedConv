...
class _ConvNd(Module):
    ...
    def __init__(self,
        ...
        self.reset_parameters(positive=positive, initialize_factor=initialize_factor)

    def reset_parameters(self, positive=False, initialize_factor=1) -> None:
        # Setting a=sqrt(5) in kaiming_uniform is the same as initializing with
        # uniform(-1/sqrt(k), 1/sqrt(k)), where k = weight.size(1) * prod(*kernel_size)
        # For more details see: https://github.com/pytorch/pytorch/issues/15314#issuecomment-477448573
        init.kaiming_uniform_(self.weight, a=math.sqrt(5), positive=positive, initialize_factor=initialize_factor)
        if self.bias is not None:
            fan_in, _ = init._calculate_fan_in_and_fan_out(self.weight)
            if fan_in != 0:
                bound = 1 / math.sqrt(fan_in)
                if positive:
                    init.uniform_(self.bias, -bound * initialize_factor, bound * initialize_factor)
                else:
    ...
    * :attr:`dilation` controls the spacing between the kernel points; also
    ...
    def __init__(
        ...
        super(Conv2d, self).__init__(
            in_channels, out_channels, kernel_size_, stride_, padding_, dilation_,
            False, _pair(0), groups, bias, padding_mode, positive=positive,
            initialize_factor=initialize_factor, **factory_kwargs)
...
class _ConvTransposeNd(_ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 ...
                 groups, bias, padding_mode, device=None, dtype=None, positive=False) -> None:
        ...
        super(_ConvTransposeNd, self).__init__(
            ...
            padding, dilation, transposed, output_padding,
            groups, bias, padding_mode, positive=positive, **factory_kwargs)
    ...
    * :attr:`dilation` controls the spacing between the kernel points; also known as the à trous algorithm.
    ...
    def __init__(
        ...
        super(ConvTranspose2d, self).__init__(
            in_channels, out_channels, kernel_size, stride, padding, dilation,
            True, output_padding, groups, bias, padding_mode, positive=positive, **factory_kwargs)
