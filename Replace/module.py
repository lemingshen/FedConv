...
class Module:
        ...
        for name, param in local_state.items():
            ...
            if key in state_dict:
                ...
                try:
                    ...
                    # param = input_param.clone()
                    # param.copy_(input_param)
                    if keep_graph:
                        self._parameters[name] = input_param.clone().to(torch.device('cuda'))
                    else:
                        with torch.no_grad():
                            param.copy_(input_param)
    ...
    def load_state_dict(self, state_dict: Mapping[str, Any],
        ...
        def load(module, local_state_dict, prefix='', keep_graph=False):
            ...
            for name, child in module._modules.items():
                if child is not None:
                    ...
                    load(child, child_state_dict, child_prefix, keep_graph)
        ...
        load(self, state_dict, keep_graph=keep_graph)
        del load
